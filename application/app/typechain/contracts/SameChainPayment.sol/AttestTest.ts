...
export interface AttestTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "paymentAddress"
      | "paymentAndAttest"
...
export interface AttestTest extends BaseContract {
  connect(runner?: ContractRunner | null): AttestTest;
  waitForDeployment(): Promise<this>;

  interface: AttestTestInterface;
